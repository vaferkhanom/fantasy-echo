  ...
  await tx(async client => {
    ...
    for (const c of clubs) {
      const { rows: r } = await client.query(
        `INSERT INTO clubs (slug, fa_name, en_name, city, tier, tsdb_id, color1, color2, v3id)
         VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9) RETURNING id`,
        [c.slug, c.fa_name, c.en_name, c.city, c.tier, c.tsdb_id, c.color1, c.color2, c.v3id ?? null]);
      clubIds[c.slug] = r[0].id;
    }
    console.log('[seed] clubs inserted');
    let n = 0;
    for (const [slug, list] of Object.entries(playersSeed)) {
      for (const [fa, en, pos, price, isForeign, v3id, portrait] of list) {
        await client.query(
          `INSERT INTO players (club_id, fa_name, en_name, pos, price, is_foreign, v3id, portrait)
           VALUES ($1,$2,$3,$4,$5,$6,$7,$8)`,
          [clubIds[slug], fa, en, pos, price / 10, !!isForeign, v3id ?? null, portrait ?? null]);
        n++;
      }
    }
